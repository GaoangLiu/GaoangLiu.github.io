...
% Start connecting all.
    ...
    \draw [ArrowC1,red] (c) -- (mux1) -- (add1) -| (func1);
    
    % Inputs
    \draw [ArrowC2,red] (h) -| (ibox4);
    \draw [ArrowC1] (h -| ibox1)++(-0.5,0) -| (ibox1); 
    \draw [ArrowC1] (h -| ibox2)++(-0.5,0) -| (ibox2);
    \draw [ArrowC1] (h -| ibox3)++(-0.5,0) -| (ibox3);
    \draw [ArrowC1,red] (x) -- (x |- h)-| (ibox3);

    % Internal
    \draw [->, ArrowC2] (ibox1) -- (mux1);
    \draw [->, ArrowC2] (ibox2) |- (mux2);
    \draw [->, ArrowC2] (ibox3) -- (mux2);
    \draw [->, ArrowC2,red] (ibox4) |- (mux3);
    \draw [->, ArrowC2] (mux2) -- (add1);
    \draw [->, ArrowC1,red] (add1 -| func1)++(-0.5,0) -| (func1);
    \draw [->, ArrowC2,red] (func1) -- (mux3);

    %Outputs
    \draw [-, ArrowC2,red] (mux3) |- (h2);
